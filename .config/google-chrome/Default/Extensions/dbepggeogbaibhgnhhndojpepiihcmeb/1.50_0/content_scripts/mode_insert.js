...
(function() {
  ...
  InsertMode = (function(superClass) {
    ...
    InsertMode.prototype.updateBadge = function(badge) {
      if (this.badge) {
        badge.badge || (badge.badge = this.badge);
      }
      if (this.isActive(badge)) {
        return badge.badge || (badge.badge = "I");
      }
    };
