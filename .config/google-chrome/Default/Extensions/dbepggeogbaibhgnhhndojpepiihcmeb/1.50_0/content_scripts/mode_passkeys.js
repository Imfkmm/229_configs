...
(function() {
  ...
  PassKeysMode = (function(superClass) {
      ...
      PassKeysMode.__super__.constructor.call(this, {
        ...
        keydown: (function(_this) {
          return function(event) {
            return _this.handleKeyChar(KeyboardUtils.getKeyChar(event));
          };
        })(this),
        keypress: (function(_this) {
          return function(event) {
            return _this.handleKeyChar(String.fromCharCode(event.charCode));
          };
        })(this),
    ...
    PassKeysMode.prototype.handleKeyChar = function(keyChar) {
