...
(function() {
  ...
  settings = {
    ...
    values: {},
    loadedValues: 0,
    valuesToLoad: ["scrollStepSize", "linkHintCharacters", "linkHintNumbers", "filterLinkHints", "hideHud", "previousPatterns", "nextPatterns", "regexFindMode", "userDefinedLinkHintCss", "helpDialog_showAdvancedCommands", "smoothScroll", "grabBackFocus"],
    isLoaded: false,
    eventListeners: {},
    init: function() {
    ...
    load: function() {
      ...
      for (i in this.valuesToLoad) {
        results.push(this.port.postMessage({
          operation: "get",
  ...
  window.initializeWhenEnabled = function() {
